(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-polygon-draw', ['exports', '@angular/core'], factory) :
    (factory((global['ngx-polygon-draw'] = {}),global.ng.core));
    ...
    var NgxPolygonDrawService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgxPolygonDrawService.ngInjectableDef = i0.defineInjectable({ factory: function NgxPolygonDrawService_Factory() { return new NgxPolygonDrawService(); }, token: NgxPolygonDrawService, providedIn: "root" });
    ...
    var NgxPolygonDrawComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxPolygonDrawComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 }
            ];
        };
        NgxPolygonDrawComponent.propDecorators = {
            src: [{ type: i0.Input }],
            created: [{ type: i0.Output }],
            polygon: [{ type: i0.ViewChild, args: ['polygon',] }]
        };
    ...
    exports.NgxPolygonDrawService = NgxPolygonDrawService;
    exports.NgxPolygonDrawComponent = NgxPolygonDrawComponent;
    exports.NgxPolygonDrawModule = NgxPolygonDrawModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-polygon-draw.umd.js.map